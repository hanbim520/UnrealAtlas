...
//#include UE_INLINE_GENERATED_CPP_BY_NAME(CustomPaperSpriteFactory)

#define LOCTEXT_NAMESPACE "Paper2D"

/////////////////////////////////////////////////////
// UCustomPaperSpriteFactory

UCustomPaperSpriteFactory::UCustomPaperSpriteFactory(const FObjectInitializer& ObjectInitializer)
...
bool UCustomPaperSpriteFactory::ConfigureProperties()
{
	//@TODO: Maybe create a texture picker here?
	return true;
}

UObject* UCustomPaperSpriteFactory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
	...
	if (InitialTexture != nullptr)
	{
		...
		for (const FString& NameToTest : NamesToTest)
		{
			...
			FAssetData AssetData = AssetRegistryModule.Get().GetAssetByObjectPath(FName(FSoftObjectPath(ObjectPathToTest).ToString()));
